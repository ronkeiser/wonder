...
export async function createWorkspace(
  ...
  const workspace = await graphRepo.createWorkspace(ctx.db, {
    name: data.name,
...
export async function getWorkspace(ctx: ServiceContext, workspaceId: string) {
  ...
  const workspace = await graphRepo.getWorkspace(ctx.db, workspaceId);
  if (!workspace) {
...
export async function listWorkspaces(
  ...
  return await graphRepo.listWorkspaces(ctx.db, options);
}
...
export async function updateWorkspace(
  ...
  const workspace = await graphRepo.updateWorkspace(ctx.db, workspaceId, {
    name: data.name,
...
export async function deleteWorkspace(ctx: ServiceContext, workspaceId: string) {
  ...
  await graphRepo.deleteWorkspace(ctx.db, workspaceId);
...
export async function createProject(
  ...
  const project = await graphRepo.createProject(ctx.db, {
    workspace_id: data.workspace_id,
    name: data.name,
...
export async function getProject(ctx: ServiceContext, projectId: string) {
  ...
  const project = await graphRepo.getProject(ctx.db, projectId);
  if (!project) {
...
export async function deleteProject(ctx: ServiceContext, projectId: string) {
  ...
  await graphRepo.deleteProject(ctx.db, projectId);
