...
-- Action: LLM Call for "Hello World"
...
VALUES (
  ...
  1,
  'llm_call',
  '{"model_profile_id":"01JDXSEED0000MODELPROF0001","prompt":"Generate a warm, friendly greeting for someone named {{name}}. Keep it short and cheerful."}',
  '{"name":"string"}',
  '{"greeting":"string"}',
  '{"timeout_seconds":30}',
  '{"level":"call"}',
