...
INSERT INTO `__new_workflow_defs`("id", "name", "description", "version", "owner_type", "owner_id", "tags", "input_schema", "output_schema", "output_mapping", "context_schema", "initial_node_id", "created_at", "updated_at") SELECT "id", "name", "description", "version", "owner_type", "owner_id", "tags", "input_schema", "output_schema", "output_mapping", "context_schema", "initial_node_id", "created_at", "updated_at" FROM `workflow_defs`;--> statement-breakpoint
