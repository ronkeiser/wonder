...
export const CreatePersonaSchema = z
  .object({
    ...
    contextAssemblyWorkflowDefId: z.string().min(1).openapi({ example: 'wfdef_context' }),
    memoryExtractionWorkflowDefId: z.string().min(1).openapi({ example: 'wfdef_memory' }),
...
export const PersonaSchema = z
  .object({
    ...
    contextAssemblyWorkflowDefId: z.string(),
    memoryExtractionWorkflowDefId: z.string(),
