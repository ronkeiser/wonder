...
describe('basic context', () => {
  ...
  it('escaping text', () => {
    expectTemplate("Awesome's")
      .withMessage("text is escaped so that it doesn't get caught on single quotes")
  ...
  it('block functions with context argument', () => {
    expectTemplate('{{#awesome 1}}inner {{.}}{{/awesome}}')
      .withInput({
        awesome: (context: number, options: any) => {
